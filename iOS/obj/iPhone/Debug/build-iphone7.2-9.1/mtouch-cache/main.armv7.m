...
extern void *mono_aot_module_Samples_PCL_iOS_info;
...
extern void *mono_aot_module_Samples_PCL_info;
...
{
	mono_aot_register_module (mono_aot_module_Samples_PCL_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_Samples_PCL_info);
...
void xamarin_setup ()
{
	...
	xamarin_executable_name = "Samples-PCL.iOS.exe";
