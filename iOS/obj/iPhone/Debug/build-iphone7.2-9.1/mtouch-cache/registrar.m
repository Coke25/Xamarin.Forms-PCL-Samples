...
@implementation AppDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, p1, "UIKit.UIApplication, Xamarin.iOS", "Foundation.NSDictionary, Xamarin.iOS", "SamplesPCL.iOS.AppDelegate, Samples-PCL.iOS", "FinishedLaunching");
	}

	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_5 (self, _cmd, &managed_method, "SamplesPCL.iOS.AppDelegate, Samples-PCL.iOS", ".ctor");
	}
@end
...
@end
	...
	static MTClassMap __xamarin_class_map [] = {
		...
		{"AppDelegate", "SamplesPCL.iOS.AppDelegate, Samples-PCL.iOS", NULL },
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [14].handle = objc_getClass ("NSFileManager");
	...
	__xamarin_class_map [27].handle = objc_getClass ("UIPageViewController");
	...
	__xamarin_class_map [60].handle = objc_getClass ("NSProcessInfo");
	__xamarin_class_map [61].handle = objc_getClass ("NSNotification");
	__xamarin_class_map [62].handle = objc_getClass ("NSIndexSet");
	__xamarin_class_map [63].handle = objc_getClass ("CTTelephonyNetworkInfo");
	__xamarin_class_map [64].handle = objc_getClass ("CTCarrier");
	...
	__xamarin_class_map [132].handle = objc_getClass ("__UIGestureRecognizerParametrizedToken");
	...
	__xamarin_class_map [145].handle = objc_getClass ("__XamarinObjectObserver");
	...
	__xamarin_class_map [150].handle = [PLCrashReporterConfig class];
	__xamarin_class_map [151].handle = [PLCrashReporter class];
	__xamarin_class_map [152].handle = [PLCrashReportApplicationInfo class];
	__xamarin_class_map [153].handle = [PLCrashReportProcessorInfo class];
	__xamarin_class_map [154].handle = [PLCrashReportBinaryImageInfo class];
	__xamarin_class_map [155].handle = [PLCrashReportSymbolInfo class];
	__xamarin_class_map [156].handle = [PLCrashReportStackFrameInfo class];
	__xamarin_class_map [157].handle = [PLCrashReportRegisterInfo class];
	__xamarin_class_map [158].handle = [PLCrashReportThreadInfo class];
	__xamarin_class_map [159].handle = [PLCrashReportExceptionInfo class];
	__xamarin_class_map [160].handle = [PLCrashReportMachineInfo class];
	__xamarin_class_map [161].handle = [PLCrashReportMachExceptionInfo class];
	__xamarin_class_map [162].handle = [PLCrashReportProcessInfo class];
	__xamarin_class_map [163].handle = [PLCrashReportSignalInfo class];
	__xamarin_class_map [164].handle = [PLCrashReportSystemInfo class];
	__xamarin_class_map [165].handle = [PLCrashReport class];
	__xamarin_class_map [166].handle = [PLCrashReportTextFormatter class];
	...
	__xamarin_class_map [196].handle = [Xamarin_Forms_Platform_iOS_ToolbarRenderer class];
	...
	__xamarin_class_map [206].handle = [Xamarin_Forms_Platform_iOS_CarouselPageRenderer_PageContainer class];
	__xamarin_class_map [207].handle = [Xamarin_Forms_Platform_iOS_CarouselPageRenderer class];
	__xamarin_class_map [208].handle = [Xamarin_Forms_Platform_iOS_DatePickerRenderer class];
